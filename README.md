...
<body>
  ...
  <section id="about" class="section-band">
    ...
    <p class="section-sub">B.Tech (AI&DS) graduate aspiring to begin a career in the IT industry. Possess strong analytical, programming, and problem-solving skills, with a keen interest in data analysis. Eager to learn new technologies and contribute to organizational success.</p>
  </section>
  ...
  <section id="contact" class="section-band">
    ...
    <div class="card" style="max-width: 720px;">
      <p><strong>Email:</strong> nishanthsenthil2004@gmail.com</p>
      <p><strong>Phone:</strong> 9092028536</p>
    </div>
  </section>

  <footer>
    © 2026 Nishanth S · Beige/Brown Resume Theme
  </footer>
</body>
</html>
